...
//            }
        ...
        echo "Jobe Started_by_user = $(cat buildlog.txt | grep "Started by user")" >> ${WORKSPACE}/${BUILD_NUMBER}-log.txt
        echo "Full Job logs = $(cat ${WORKSPACE}/buildlog.txt)" >> ${WORKSPACE}/${BUILD_NUMBER}-log.txt
